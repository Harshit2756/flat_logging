...
class HSizes {
  HSizes._(); // Private constructor to prevent instantiation
  ...
  static bool isTablet(double screenWidth) => screenWidth >= breakpointMobile && screenWidth < breakpointDesktop;
